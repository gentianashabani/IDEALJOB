...
<body>
    ...
    <div class="container">
        ...
        <br>
        <h3 class="header-three">Fusha e interesit 6 Planifikimi, llogaritja, vizatimi teknik, informatika, hulumtimi</h3>

        <div id="question-1">
        <?php  echo "<p> <font size = 4>1.Shpesh i zgjidhë pyetjet e ndërlikuara.</font> </p>";?>
        ...
        <div id="question-2">
        <?php  echo "<p> <font size = 4>2.Kryej me dëshirë punë që kërkojnë saktësi, matje, llogaritje, programim etj.</font> </p>";?>
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>3.Më interesojnë Fizika dhe Kimia.</font> </p>";?>
        ...
        <div id="question-4">
        <?php  echo "<p> <font size = 4>4.Më pëlqen Matematika .</font> </p>";?>
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>5.Më intereson hulumtimi i fuqive natyrore (p.sh. elektriciteti, energjia bërthamore, energjia solare etj.) .</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>6.Më intereson kompjuteri dhe programet kompjuterike .</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>7.Më intereson se si funksionojnë saktësisht dirigjuesit elektronik.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>8.Lexoj me kënaqësi artikuj mbi burime natyrore të energjisë .</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>9.Vizatimet teknike dhe planet janë interesante.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>10.Më pëlqejnë eksperimentet teknike.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>11.Më interesojnë çështje nga Fizika, p.sh, çfarë është një atom? .</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>12.Më interesojnë zhvillimet aktuale të teknikë dhe shkenca natyrore.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>13.Interesohem për mundësitë më të reja te teknologjisë laserike.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>14.Unë di formula të rëndësishme fizike/kimike.</font> </p>";?>
            <form id="form-question-3">
    ...
    <div class="contanier">
        <div id=" home" class="flex-column flex-center">
            <a href="game7.php" class="btn">Vazhdoni</a>
        </div>
</body>
