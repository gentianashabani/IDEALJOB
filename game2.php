...
<body>
    ...
    <div class="container">
        ...
        <br>
        <h3 class="header-three">Fusha e interesit 2 USHQIMI</h3>

        <div id="question-1">
        <?php  echo "<p> <font size = 4>1.Më duket interesante puna në kuzhinë.</font> </p>";?>
        ...
        <div id="question-2">
        <?php  echo "<p> <font size = 4>2.Më pëlqen të shërbej mysafirët.</font> </p>";?>
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>3.Me dëshirë ndihmoj në përgatitjen e tavolinës dhe ushqimit.</font> </p>";?>
        ...
        <div id="question-4">
        <?php  echo "<p> <font size = 4>4.Me dëshirë gatuaj në kohën e lirë.</font> </p>";?>
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>5.Para se të filloj me gatim, i lë vetes mjaftueshëm kohë për parapërgatitje. </font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>6.Ushqimi dhe amvisëria janë lëndët e mia të preferuara.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>7.Me dëshirë blej gjëra ushqimore.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>8.Me dëshirë do të përgatisja një meny.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>9.Me dëshirë do gatuaja bukë me lloje të ndryshme të miellit.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>10. Kënaqem kur e servoj ushqimin bukur.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>11.Kam ndihmuar në dekorimin e sallatave.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>12.Më pëlqen të përgatis vetë marmelatën.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>13.Me dëshirë do bëja ëmbëlsira nga çokolata në forma të ndryshme.</font> </p>";?>
            <form id="form-question-3">
        ...
        <div id="question-3">
        <?php  echo "<p> <font size = 4>14. Interesohem shumë për ushqim të shëndoshë.</font> </p>";?>
            <form id="form-question-3">
    ...
    <div class="contanier">
        <div id=" home" class="flex-column flex-center">
            <a href="game3.php" class="btn">Vazhdoni</a>
        </div>
</body>
